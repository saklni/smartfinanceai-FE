...
export default function Dashboard() {
  ...
  const summary = analytics.summary || { income: 0, expense: 0, balance: 0, saving_progress: 0, saving_rate: 0, expense_ratio: 0 }
  const categories = analytics.categories || []
  const trend = analytics.trend || []
  const hasTransactions = transactions.length > 0

  // Ambil satu rekomendasi dari summary untuk Insight panel
  ...
  return (
    <section className="page page-enter">
      ...
      <div className="dashboard-grid">
        <div className="panel large interactive-card">
          ...
          {trend.length ? (
            <ResponsiveContainer width="100%" height={280}>
              <AreaChart data={trend}>
                ...
                <Area type="monotone" dataKey="expense" stroke="#f97316" fill="#fed7aa" />
              </AreaChart>
            </ResponsiveContainer>
          ) : (
